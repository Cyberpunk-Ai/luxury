...
import { insertContactSchema, insertWishlistSchema, type SearchFilters } from "@shared/schema";
...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  app.post("/api/wishlist", async (req, res) => {
    try {
      ...
      const exists = await storage.isInWishlist(validatedData.userId, validatedData.assetId);
      if (exists) {
